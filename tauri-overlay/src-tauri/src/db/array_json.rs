...
pub(super) struct ReplayCacheArrayJson;

impl ReplayCacheArrayJson {
    pub(super) fn encode_f64(values: &[f64]) -> Result<String, ReplayCacheDbError> {
        Self::encode_json_array("f64 array", values)
    }

    pub(super) fn decode_f64(text: &str) -> Result<Vec<f64>, ReplayCacheDbError> {
        Self::decode_json_array("f64 array", text)
    }

    pub(super) fn encode_strings(values: &[String]) -> Result<String, ReplayCacheDbError> {
        Self::encode_json_array("string array", values)
    }

    pub(super) fn decode_strings(text: &str) -> Result<Vec<String>, ReplayCacheDbError> {
        Self::decode_json_array("string array", text)
    }

    pub(super) fn encode_u64(values: &[u64]) -> Result<String, ReplayCacheDbError> {
        Self::encode_json_array("u64 array", values)
    }

    pub(super) fn decode_u64(text: &str) -> Result<Vec<u64>, ReplayCacheDbError> {
        Self::decode_json_array("u64 array", text)
    }

    pub(super) fn encode_u32(values: &[u32]) -> Result<String, ReplayCacheDbError> {
        Self::encode_json_array("u32 array", values)
    }

    pub(super) fn decode_u32(text: &str) -> Result<Vec<u32>, ReplayCacheDbError> {
        Self::decode_json_array("u32 array", text)
    }

    pub(super) fn encode_stat_values(
        values: &[CacheStatValue],
    ) -> Result<String, ReplayCacheDbError> {
        Self::encode_json_array("stat value array", values)
    }

    pub(super) fn decode_stat_values(
        text: &str,
    ) -> Result<Vec<CacheStatValue>, ReplayCacheDbError> {
