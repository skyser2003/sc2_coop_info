use sco_tauri_overlay::OverlayInfoOps;
...
fn open_folder_rejects_empty_path() {
    let error = OverlayInfoOps::open_folder_in_explorer("  ")
...
fn open_folder_rejects_missing_folder() {
    ...
    let error = OverlayInfoOps::open_folder_in_explorer(&missing.to_string_lossy())
