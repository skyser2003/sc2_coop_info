...
fn replay_move_target_index_resets_to_most_recent_when_overlay_has_no_replay_data() {
    let replays = vec![
        sample_replay(&test_replay_path("newest.SC2Replay")),
        sample_replay(&test_replay_path("middle.SC2Replay")),
        sample_replay(&test_replay_path("oldest.SC2Replay")),
    ];
    let selected = Some(test_replay_path("oldest.SC2Replay"));
...
fn replay_move_target_index_moves_relative_to_selected_replay_when_data_is_active() {
    ...
    let selected = Some(test_replay_path("middle.SC2Replay"));
...
fn replay_for_display_falls_back_to_most_recent_cached_replay() {
    let replays = vec![
        sample_replay(&test_replay_path("newest.SC2Replay")),
        sample_replay(&test_replay_path("older.SC2Replay")),
    ];
