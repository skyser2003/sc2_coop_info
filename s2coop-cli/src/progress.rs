...
pub struct CacheProgressUpdate {
    processed: u64,
    total: u64,
    eta: Option<String>,
}

impl CacheProgressUpdate {
    pub fn new(processed: u64, total: u64, eta: Option<String>) -> Self {
        Self {
            processed,
            total,
            eta,
...
impl CliProgressBar {
    ...
    pub fn parse_update(message: &str) -> Option<CacheProgressUpdate> {
        let mut eta = None;
    ...
    pub fn update(progress_bar: &ProgressBar, message: &str) {
